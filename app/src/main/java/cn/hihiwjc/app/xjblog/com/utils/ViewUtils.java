...
public class ViewUtils {
	...
	public static int getResId(String resName, String defType) {
		try {
			String packageName = App.getSelf().getPackageName();
			Resources resources = App.getSelf().getPackageManager().getResourcesForApplication(packageName);
...
//		MToast.showMessage(message);
		Toast.makeText(App.getSelf(), message, Toast.LENGTH_SHORT).show();
	}

	public static void showMessage(int messageId) {
//		MToast.showMessage(messageId);
		Toast.makeText(App.getSelf(), messageId, Toast.LENGTH_SHORT).show();
	}
