...
public class Utils {
	...
	public static int dip2px(int dipValue) {
		float reSize = App.getSelf().getResources().getDisplayMetrics().density;
	...
	public static float sp2px(int spValue) {
		return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, spValue, App.getSelf().getResources().getDisplayMetrics());
	}
